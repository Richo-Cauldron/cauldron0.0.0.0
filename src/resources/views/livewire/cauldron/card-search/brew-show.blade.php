<div class="container ml-10">
    <h1 class="text-red-600"><span class="text-black">Page Component: </span>
        app/Http/Livewire/Cauldron/CardSearch/BrewShow Component</h1>
    <br>
    <hr>
    <br>
    ...
    <div>
        ...
        <img class="mt-4" src="{{ $showCard['image_uris']['small'] }}" alt="small">
    </div>
    <br><br>
    <hr>
    <br>
    ...
    <div>
        <span class="font-semibold">Card P/T: </span>
            @if (isset($showCard['power']))
                {{ $showCard['power'] }}
            @else
                {{ $undefined }}
            @endif
            <span>/</span>
            @if (isset($showCard['toughness']))
                {{ $showCard['toughness'] }}
            @else
                {{ $undefined }}
            @endif
