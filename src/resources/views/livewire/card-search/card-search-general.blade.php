    ...
    <div class="p-8">
        <div >
            <div class="flex items-center bg-white rounded-full shadow-xl">
                <input wire:model.lazy="cardSearchValue" class="w-full px-6 py-4 leading-tight text-gray-700 border-0 rounded-l-full focus:outline-0 focus:border-current" id="search" type="text" placeholder="Search">
...
{{-- <div>
                <img src="{{ $searchImageResults }}" alt="">
              
               <input wire:model.lazy="imageSearchValue"
            </div> --}}